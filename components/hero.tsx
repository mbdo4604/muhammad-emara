            ...
            <div className="grid grid-cols-5 items-end gap-1">
              {site.brandBar.map((item, index) => (
                ...
                >
                  ...
                  <span className="brand-mark text-center text-[clamp(2.4rem,14vw,4.2rem)] leading-[0.82] tracking-[-0.04em] text-white">
                    {item.letter}
                  </span>
                </div>
              ))}
            ...
            <div className="flex items-end">
              {site.brandBar.map((item, index) => (
                ...
                >
                  ...
                  <span className="brand-mark inline-block px-[0.02em] text-[clamp(3rem,10.5vw,12rem)] leading-[0.78] tracking-[-0.09em] text-white">
                    {item.letter}
                  </span>
                </div>
              ))}
